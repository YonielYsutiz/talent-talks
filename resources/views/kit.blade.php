...
<head>
  ...
  <script>
    function markDownloadKit(user_id) {
      const url = 'http://127.0.0.1:8000/api/KitController';
      const data = {
  ...
  <section id="home" class="home drawer drawer--left">
    <div class="banner-title ">
      ...
      <div class="event-schedule">
        ...
        <span class="event-date"></i>KIT TALENT FEST</span>
      </div>
      ...
      <div class="register-now-section"> <a href="#" onclick="markDownloadKit('{{ Auth::user()->id }}')" class="register-now-btn">Descargar Kit<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a> </div>
      @else
      <p class="event-description" style="padding: 0 3.5em;">Actualmente posees: {{ Auth::user()->getPoints(Auth::user()->id) }} puntos</p>
      @endif
      @endguest
